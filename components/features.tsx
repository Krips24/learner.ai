...
export function Features() {
  ...
  return (
    <section id="features" className="relative py-24 sm:py-32">
      {/* Background elements */}
      <div className="absolute -left-20 top-1/3 h-64 w-64 rounded-full bg-green-500/10 blur-[80px]"></div>
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group relative rounded-xl border border-gray-800 bg-gray-900/50 p-6 transition-all hover:bg-gray-900 hover:shadow-lg hover:shadow-green-500/10"
            >
              ...
              <div className="absolute -left-px -top-px h-px w-0 bg-gradient-to-r from-blue-400/0 via-blue-400 to-green-400/0 transition-all duration-500 group-hover:w-full"></div>
            </div>
          ))}
        </div>
      </div>
